...
//							 true(증거가 있을 때)
							...
							System.out.println(nick + " : (증인이 있군...하지만 다른 트릭이 있을수도 있어!)");
...
//						 true(증거가 있을 때)
							...
							System.out.println(
									"현도 : 저는 건물 전체를 순찰중이었습니다. 1층부터 4층까지... 강의실에서는 서하라 선생님을 만났고, 교무실에는 김지은 선생님이 있었습니다.");
...
//							 true(증거가 있을 때)
							...
							System.out.println("지은 : 저 사실... 9시 20분에 PBK 선생님을 만나서... 선물을 줬어요! 까지는 살아계셨다구요!");
							System.out.println("저는... 상민학생이 의심가요.. 사실 문에 너무 고생을 많이 했거든요..");//
